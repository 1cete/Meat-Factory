...
class Klientas:
    def __init__(self, vardas, pradLaikas):
        self.vardas = vardas
        self.pinigai = 50
        self.mesa = 50  
        self.pakuotes = 5  
    ...
    def __str__(self):
        return f'{self.vardas};"{self.pinigai};{self.mesa};{self.pakuotes};{self.uzsakymai};{self.masina_sugedo};{self.reali_praejo_laikas};{self.pradLaikas};{self.pabLaikas}'
